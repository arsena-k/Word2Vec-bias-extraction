...
def select_testing_set(testingset, yourmodelhere):
    if testingset=='gender':
        ...
        train_word_list_checked, train_words, train_classes= select_training_set('gender_3', yourmodelhere)  #note that many of these dimensions are likely picking up similar signal of "valence." We can see this, in part, because if we use a trainig set from one dimensiion we still do well on the testing set form another dimensions.  In Parts B and C we saw that the cosine smilarity of the extracted dimension was not 1, meaning that these methods are NOT picking up the same thing. Its a little less clear with this ML method, but this ML method is still an interesting experiment.  
        ...
        for i in masc2:
            test_classes.append(i)
        train_word_list_checked, train_words, train_classes= select_training_set('moral', yourmodelhere)  #note that many of these dimensions are likely picking up similar signal of "valence." We can see this, in part, because if we use a trainig set from one dimensiion we still do well on the testing set form another dimensions.  In Parts B and C we saw that the cosine smilarity of the extracted dimension was not 1, meaning that these methods are NOT picking up the same thing. Its a little less clear with this ML method, but this ML method is still an interesting experiment.  
        ...
        for i in masc2:
            test_classes.append(i) 
        train_word_list_checked, train_words, train_classes= select_training_set('health', yourmodelhere)  #note that many of these dimensions are likely picking up similar signal of "valence." We can see this, in part, because if we use a trainig set from one dimensiion we still do well on the testing set form another dimensions.  In Parts B and C we saw that the cosine smilarity of the extracted dimension was not 1, meaning that these methods are NOT picking up the same thing. Its a little less clear with this ML method, but this ML method is still an interesting experiment.  
        ...
        for i in masc2:
            test_classes.append(i) 
        train_word_list_checked, train_words, train_classes= select_training_set('ses', yourmodelhere)  #note that many of these dimensions are likely picking up similar signal of "valence." We can see this, in part, because if we use a trainig set from one dimensiion we still do well on the testing set form another dimensions.  In Parts B and C we saw that the cosine smilarity of the extracted dimension was not 1, meaning that these methods are NOT picking up the same thing. Its a little less clear with this ML method, but this ML method is still an interesting experiment.  
